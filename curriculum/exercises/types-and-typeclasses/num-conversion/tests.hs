...
main = do
  results <- sequence
    [ assertEqual "converts a positive int" (intToDouble 5) 5.0
    , assertEqual "converts zero" (intToDouble 0) 0.0
    , assertEqual "converts a negative int" (intToDouble (-3)) (-3.0)
    ]
